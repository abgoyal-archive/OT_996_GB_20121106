...
/*--------------------------------------------------------------------------------------*/
/*    Comments :                                                             */
/*    File     : external/bluetooth/bluez/src/dbus-hci.c                     */
/*    Labels   :                                                             */
/*======================================================================================*/
...
/*---------|------------------|--------------------------|------------------------------*/
/*11/17/11| Hualan Su     |CR187992-Hualan-Su-001 | merge broadcom patch     */
/*======================================================================================*/
#ifdef HAVE_CONFIG_H
#include <config.h>
#endif
...
int hcid_dbus_user_confirm(bdaddr_t *sba, bdaddr_t *dba, uint32_t passkey)
{
	...
	if (!get_adapter_and_device(sba, dba, &adapter, &device, TRUE))
		return -ENODEV;
       //CR187992-Hualan-Su-001-Add-begin
	...
	if (passkey == 0x80000000) //This is used as Bluetooth.Error in the JAVA space
	{
      ...
      //--- BRCM_LOCAL
       //CR187992-Hualan-Su-001-Add-end
