...
L_CFLAGS += -DANDROID_BRCM_P2P_PATCH -DANDROID -DCONFIG_CTRL_IFACE_UNIX 
...
INCLUDES += external/wpa_supplicant_6/libnl/include
INCLUDES += external/wpa_supplicant_6/libnl/include/linux/
endif
OBJS = config.c
OBJS += notify.c
OBJS += bss.c
...
ifdef CONFIG_JRD_EAP_SIM_AKA
CONFIG_USIM_SIMULATOR=y
CONFIG_SIM_SIMULATOR=y
L_CFLAGS += -DANDROID_JRD_SIM_AKA
