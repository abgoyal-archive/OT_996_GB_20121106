...
//PR-230835 Qiwu.Li modified begin
//extern int g_selected_registrar;
//PR-230835 Qiwu.Li modified end
static void eapol_auth_tx_req(struct eapol_state_machine *sm)
{
	...
	//PR-230835 Qiwu.Li modified begin
	/*if (!g_selected_registrar) {
		wpa_printf(MSG_DEBUG, "%s(): EAPOL: Drop EAPOL TX to " MACSTR
			   ", g_selected_registrar is %d",
			   __func__, MAC2STR(sm->addr), g_selected_registrar);
		return;
	}*/
	//PR-230835 Qiwu.Li modified end
