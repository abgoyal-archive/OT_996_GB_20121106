...
enum wpa_event_type {
	...
	/**
	 * EVENT_P2P_GO_NEG_RES_RX - Report reception of GO Negotiation Response
	 *
	 * This event is used only if the driver implements P2P management
	 * internally. Event data is stored in
	 * union wpa_event_data::p2p_go_neg_res_rx.
	 */
	EVENT_P2P_GO_NEG_RES_RX,
...
union wpa_event_data {
	...
	/**
	 * struct p2p_go_neg_res_rx - Data for EVENT_P2P_GO_NEG_RES_RX
	 */
	struct p2p_go_neg_res_rx {
		const u8 *src;
		int status;
	} p2p_go_neg_res_rx;
